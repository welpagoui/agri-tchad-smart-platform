...
// MARCHÉ : PUBLIER (Correction ici)
app.post('/api/marketplace', async (req, res) => {
    const { agriculteur_id, produit, prix, quantite } = req.body;
    try {
        await pool.query(
            'INSERT INTO produits (agriculteur_id, nom_produit, prix, quantite) VALUES ($1,$2,$3,$4)', 
...
app.listen(PORT, '0.0.0.0', () => console.log("🚀 AGRI-TCHAD MASTER OK"));